	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mListener = new LinphoneCoreListenerBase() {
			...
			public void messageReceived(LinphoneCore lc, LinphoneChatRoom cr, LinphoneChatMessage message) {
		        displayMissedChats();
				// Yoyo add for VNC viewer
				//String cmd = "kvm:Password=123456@192.168.1.104:5900";
				Intent intent = new Intent("android.intent.action.VIEW");

				intent.setData(Uri.parse("content://com.realvnc.viewer.android.data.AddressBook/entries/1"));
				intent.setAction("CONNECT");
				//intent.setClassName("com.realvnc.viewer.android","com.realvnc.viewer.android.app.ConnectionChooserActivity");
				intent.setClassName("com.realvnc.viewer.android","com.realvnc.viewer.android.app.ConnectionChooserActivity");
